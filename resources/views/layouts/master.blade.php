    ...
    @can('isAdmin')
      ...
      <li class="nav-item">
        ...
        <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Category Screens:</h6>
            <a class="collapse-item" href="login.html">Add Category</a>
            <a class="collapse-item" href="register.html">Categories</a>
          </div>
        </div>
      </li>
    @endcan
      ...
      <li class="nav-item">
        ...
        <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Order Screens:</h6>
            <a class="collapse-item" href="{{route('employee.myOrders')}}">My Order</a>
          </div>
        </div>
      </li>
    @endcan
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
             <span>Copyright &copy; {{ config('app.name', 'Laravel') }}. Developed by PremLamsal</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
